...
class Calendar:
    ...
    def selection(self, day, name):
        ...
        #data
        self.values.database['day_selected'] = day
        self.values.database['month_selected'] = self.month
        self.values.database['year_selected'] = self.year
        self.values.database['day_name'] = name
        self.values.database['month_name'] = calendar.month_name[self.month_selected]
